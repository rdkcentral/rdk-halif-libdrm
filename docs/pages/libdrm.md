...
### References
1. [http://dri.freedesktop.org/libdrm/](https://dri.freedesktop.org/libdrm/) - Downloadable libdrm files
2. [Beyond Linux® From Scratch (System V Edition)](https://www.linuxfromscratch.org/blfs/view/svn/x/libdrm.html) - An introduction to libdrm
3. [DRM Internals](https://www.kernel.org/doc/html/v4.11/gpu/drm-internals.html) - Documentation on DRM and driver details
4. [Direct Rendering Manager](https://man.archlinux.org/man/drm.7.en) - Documentation on DRM module
5. [https://github.com/Distrotech/libdrm] - Reference to open source libdrm code
